...
- [官方技能市场说明](https://codebuddy.ai/docs/workbuddy/From-Beginner-to-Expert-Guide/Function-Description/Skills-Market) - 官方文档对 Skills 市场机制与安装方式的说明。
...
- [100 条工作提效 Prompts](./prompts/100-work-efficiency-prompts.json) - 本仓库自带的提效指令库：10 大办公场景各 10 条，覆盖调研、报表、PPT、纪要、开发、运营、人事财务，每条含完整指令、预期交付物和使用技巧，可直接粘贴给 WorkBuddy 抄作业。
...
- [用 WorkBuddy 做一个提示词生成 Agent](https://agent.csdn.net/6a56fe96662f9a54cb8f84b6.html) - 从零编写 SKILL.md 的完整教学，做一个覆盖主流模型的提示词生成器，10 分钟上手。
...
- [超详细安装教程（Windows + macOS）](https://blog.csdn.net/fghyibib/article/details/159981279) - 每一步都有说明，含 UAC、防火墙与杀毒软件拦截的处理办法。
- [从入门到高阶权威教程](https://blog.csdn.net/fghyibib/article/details/159981747) - 场景攻略、技能清单与避坑指南汇总，可直接照着操作。
- [Windows 原生深度安装与调优指南](https://bbs.csdn.net/weixin_32629853/article/details/100159015) - 讲清 WorkBuddy 的桌面权限模型与沙箱机制，知其然也知其所以然。
- [WorkBuddy 从入门到精通（掘金）](https://juejin.cn/post/7620801241318506537) - 界面模块拆解、Craft / Auto / Skills 三种模式与「养虾记录」成就系统介绍。
- [腾讯 WorkBuddy 教程完全指南](https://damodev.csdn.net/69d6f5fc0a2f6a37c59ded54.html) - 5 个第一天就能用的高频场景 + 10 个高手心法，说人话、能照抄。
...
- [WorkBuddy 接入微信、飞书、钉钉指南](https://gitcode.csdn.net/69b3a7ec0a2f6a37c596f931.html) - 三大 IM 的扫码绑定与远程指挥配置，手机上发指令电脑自动干活。
...
本清单以 [CC0 1.0 Universal](LICENSE) 发布，不保留任何权利，可自由复制、修改与再分发。清单中各第三方资源的内容版权归其原作者所有。
